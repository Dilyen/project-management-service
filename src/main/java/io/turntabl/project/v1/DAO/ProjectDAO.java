package io.turntabl.project.v1.DAO;

import io.turntabl.project.v1.Transfers.ProjectTO;
...
public interface ProjectDAO {
    ...
    public List<io.turntabl.project.v1.Transfers.ProjectTO> getAllProject();
